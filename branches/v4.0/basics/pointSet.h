...
public:
	...
	int addPoint(LongInt x1,LongInt y1, int w1);
	// add an ith(according to the adding sequence)  point (x1,y1) with weight w1, return i.
	...
	static int inCircle(int p1Idx, int p2Idx, int p3Idx, int pIdx, bool useWeights);
